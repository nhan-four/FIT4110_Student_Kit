...
**May I make my repo private?** No, unless the instructor announces an exception. Grading is by ZIP download from the URL you submit.
...
**Tôi làm trong repository nào?** Dùng Student Kit để đọc hướng dẫn; Lab starter được clone để thực hành và nội dung hoàn chỉnh được sao chép vào thư mục Lab trong một repository `FIT4110_<MãSinhViên>`. **Có được để private không?** Không, trừ khi giảng viên thông báo khác. **Mock có phải service thật không?** Không; mock kiểm tra tương tác theo contract, còn service thật mới kiểm tra auth, nghiệp vụ, database và vận hành. **Nếu làm nhóm?** Theo chính sách lớp, nhưng URL duy nhất phải chứa đủ artefact và minh chứng được chấm.
